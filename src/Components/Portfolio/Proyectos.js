import icon0 from '../../assets/svgIcons/icons8-css.svg';
import icon1 from '../../assets/svgIcons/icons8-elementor.svg';
import icon2 from '../../assets/svgIcons/icons8-javascript.svg';
import icon3 from '../../assets/svgIcons/icons8-reaccionar-nativo.svg';
import icon4 from '../../assets/svgIcons/icons8-shopify.svg';
import icon5 from '../../assets/svgIcons/icons8-woocommerce.svg';
import icon6 from '../../assets/svgIcons/icons8-wordpress.svg';
import icon7 from '../../assets/svgIcons/icons8-php.svg';
import icon8 from '../../assets/svgIcons/icons8-gms.svg';
import icon9 from '../../assets/svgIcons/icons8-python.svg';
import icon10 from '../../assets/svgIcons/icons8-html.svg';

import reactImg1 from '../../assets/ProjectsImages/fotos portafolio hector valdes m gifs.webp';
import reactImg2 from '../../assets/ProjectsImages/fotos portafolio hector valdes m indicadores.webp';

import extImg1 from '../../assets/ProjectsImages/fotos portafolio hector valdes m _ Extension para Chrome.webp';
import extImg2 from '../../assets/ProjectsImages/fotos portafolio hector valdes m extension Indicadores.webp';

import wpImg1 from '../../assets/ProjectsImages/fotos portafolio hector valdes m _ Agencia Grupo Qs.webp';
import wpImg2 from '../../assets/ProjectsImages/fotos portafolio hector valdes m _ APP Drug Free Workplace.webp';
import wpImg3 from '../../assets/ProjectsImages/fotos portafolio hector valdes m _ Cantauria Estudio.webp';
import wpImg4 from '../../assets/ProjectsImages/fotos portafolio hector valdes m _ Frozen Sour.webp';
import wpImg5 from '../../assets/ProjectsImages/fotos portafolio hector valdes m vivid.webp';
import wpImg6 from '../../assets/ProjectsImages/fotos portafolio hector valdes m lubricentro.webp';
import wpImg7 from '../../assets/ProjectsImages/fotos portafolio hector valdes m temoanaori.webp';
import wpImg8 from '../../assets/ProjectsImages/fotos portafolio hector valdes m _ Cellzion.webp';
import wpImg9 from '../../assets/ProjectsImages/fotos portafolio hector valdes m _ Alfa Contadores.webp';
import wpImg10 from '../../assets/ProjectsImages/fotos portafolio hector valdes m _ Armag.webp';
import wpImg11 from '../../assets/ProjectsImages/fotos portafolio hector valdes m _ BrickPicture.webp';
import wpImg12 from '../../assets/ProjectsImages/fotos portafolio hector valdes m _ Linna-dem.webp';
import wpImg13 from '../../assets/ProjectsImages/fotos portafolio hector valdes m _ BeSpine.webp';
import wpImg14 from '../../assets/ProjectsImages/fotos portafolio hector valdes m _ Estacion Lastarria.webp';
import wpImg15 from '../../assets/ProjectsImages/fotos portafolio hector valdes m _ Quntur.webp';
import wpImg16 from '../../assets/ProjectsImages/fotos portafolio hector valdes m _ Refuerzamas.webp';
import wpImg17 from '../../assets/ProjectsImages/fotos portafolio hector valdes m _ Sin Deudas.webp';

import gms1 from "../../assets/ProjectsImages/fotos portafolio hector valdes m _ Juego The Dream of the River.webp";
import gms2 from "../../assets/ProjectsImages/fotos portafolio hector valdes m _ Juego Zombeast Under Attack.webp";
import gms3 from "../../assets/ProjectsImages/fotos portafolio hector valdes m _ Juego Humanity Part I.webp";

import codeImg1 from "../../assets/ProjectsImages/fotos portafolio hector valdes m _ Calculadora de IVA.webp";
import codeImg2 from "../../assets/ProjectsImages/fotos portafolio hector valdes m _ Juego cartas por la inclusion.webp";
...
const iconsUrl = [
    /*0*/{name: 'CSS', url:icon0},
    /*1*/{name: 'Elementor', url: icon1},
    /*2*/{name: 'JavaScript', url: icon2},
    /*3*/{name: 'React', url: icon3},
    /*4*/{name: 'Shopify', url: icon4},
    /*5*/{name: 'Woocommerce', url: icon5},
    /*6*/{name: 'WordPress', url: icon6},
    /*7*/{name: 'PHP', url: icon7},
    /*8*/{name: 'Game Maker Studio 2', url: icon8},
    /*9*/{name: 'Python', url: icon9},
    /*10*/{name: 'HTML', url: icon10},
]
